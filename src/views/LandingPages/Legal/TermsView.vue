    ...
    <div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
      <div class="row mx-2">
        <div class="col-lg-12">
          ...
          <p>
            We are Altitude Droneworks ("Company," "we," "us," "our").
          </p>
          <p>
            We operate the website altitudedroneworks.com (the "Site"), as well as any other related products and services
            that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
          </p>
          <p>
            We offer aerial and indoor photography and videography services and such as residential and commercial real
            estate, fpv flythroughs, private events, promotional videography, aerial survey and inspections, 360 site
            panoramas, corporate branding and advertising, and more.
          </p>
          <p>
            You can contact us by phone at 303 416 2945, email at altitudedroneworks@gmail.com.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of
            an entity ("you"), and Altitude Droneworks, concerning your access to and use of the Services. You agree that
            by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF
            YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND
          ...
          <p>
            We operate in full compliance with FAA part 107 regulations.
          </p>
          <p>
            2. INTELLECTUAL PROPERTY RIGHTS
          </p>
          ...
          <p>
            ...
            or commercial use. Copyright protected media will be issued to clients using the right to reproduce and the
            right to display.
          </p>
          <p>
          ...
          <p>
            ...
            access the Services through automated or non-human means, whether through a bot, script or otherwise; (4) you
            will not use the Services for any illegal or unauthorized purpose; and (5) your use of the Services will not
          ...
          <p>
            ...
            the applicable order. We reserve the right to correct any errors or mistakes in pricing, even if we have
          ...
          <p>
            ...
            Contributions you transmit may be treated in accordance with the Services' Privacy Policy. When you create or
          ...
          <p>
            ...
            Websites accessed through the Services or any Third-Party Content posted on, available through, or installed
            from the Services, including the content, accuracy, offensiveness, opinions, reliability, privacy practices,
            or other policies of or contained in the Third-Party Websites or the Third-Party Content. Inclusion of,
            linking to, or permitting the use or installation of any Third-Party Websites or any Third-Party Content does
          ...
          <p>
            ...
            the State of Colorado applicable to agreements made and to be entirely performed within the State of Colorado,
          ...
          <p>
            ...
            Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. If such costs are determined by the
            arbitrator to be excessive, we will pay all arbitration fees and expenses. The arbitration may be conducted in
            ...
            otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Douglas
            County, Colorado. Except as otherwise provided herein, the Parties may litigate in court to compel
          ...
          <p>
            ...
            prosecuted in the state and federal courts located in Douglas County, Colorado, and the Parties hereby consent
