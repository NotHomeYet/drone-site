...
import mh1 from "@/assets/img/altitude/house/mountain/mh1.jpg";
import mh2 from "@/assets/img/altitude/house/mountain/mh2.jpg";
import mh3 from "@/assets/img/altitude/house/mountain/mh3.jpg";
import house_up from "@/assets/img/altitude/house/mountain/house_up.mp4";
</script>
<template>
  <DefaultNavbar transparent />
  <div class="mx-auto body-container">
    <div class="page-header min-height-400" :style="{ backgroundImage: `url(${rein1})` }" loading="lazy">
      <span class="mask bg-gradient-dark opacity-8">
        <div class="col-lg-8 text-center mx-auto my-auto mt-8">
          ...
          <h3 class="text-white">Summit County, CO</h3>
        </div>
      </span>
    </div>
