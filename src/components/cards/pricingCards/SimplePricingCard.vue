...
<template>
    <div class="mb-lg-0 mb-4" :class="`${col ?? ''}`">
        <div class="card h-100" :class="color ?? ''">
            <div class="text-sm-start text-center pt-4 pb-3 px-4" :class="color ? 'bg-transparent' : 'card-header'">
            ...
            <div class="card-body">
                <div class="d-flex pb-3" v-for="specification of specifications" :key="specification">
                    <i class="material-icons my-auto text-dark" :class="{ 'text-white': color }">done</i>
